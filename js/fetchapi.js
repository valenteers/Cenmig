...
fetch('https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term=Pornchai%20Matangkasombut%20Microbial%20Genomics&usehistory=y&sort=pubdate')
    .then(
        function(response){
