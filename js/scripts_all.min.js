...
function prepareSignup(e) {
    var t = jQuery("<form />"),
        a = e.contents().find("form").attr("action");
...
var mr_firstSectionHeight, mr_nav, mr_navOuterHeight, mr_navScrolled = !1,
    mr_navFixed = !1,
    mr_outOfSight = !1,
...
$(document).ready(function() {
    ...
    if (function(e) {
            e.fn.popuplogin = function() {
                e(this).hasClass("open-popup") ? (e(this).removeClass("fade_in").addClass("fade_out"), setTimeout(function() {
                    e(".perfect-popup").removeClass("open-popup")
                }, 400)) : (e(this).addClass("open-popup").removeClass("fade_out").addClass("fade_in"), setTimeout(function() {}, 400))
            }
        }(jQuery), $(".menu-close-perfect a").on("click", function() {
            return $(".perfect-popup").popuplogin(), !1
        }), $(".login-togle").on("click", function() {
            var e = $(this).data("popup");
            return $("#" + e).popuplogin(), !1
        ...
        }), $(".offscreen-container a").click(function() {}), $(".projects").each(function() {
            var e = "";
            ...
            $(this).closest(".filters").find("li").removeClass("active"), $(this).addClass("active"), $(this).closest(".projects").find(".project").each(function() {
                var t = $(this).data("filter"); - 1 == t.indexOf(e) ? $(this).addClass("inactive") : $(this).removeClass("inactive")
            }), "all" == e && $(this).closest(".projects").find(".project").removeClass("inactive")
        }), $(".tweets-feed").each(function(e) {
            $(this).attr("id", "tweets-" + e)
        }).each(function(e) {
            function t(t) {
                for (var a = t.length, i = 0, o = document.getElementById("tweets-" + e), n = '<ul class="slides">'; a > i;) n += "<li>" + t[i] + "</li>", i++;
                return n += "</ul>", o.innerHTML = n, n
            }
    ...
    if (jQuery(".foundry_modal").click(function() {
            ...
            var a, i, o, n, s, r, l, d, c, m = $(this).closest("form.form-email, form.form-newsletter"),
                u = m.find('button[type="submit"]'),
                f = 0,
                p = m.attr("original-error");
            if (i = $(m).find("iframe.mail-list-form"), m.find(".form-error, .form-success").remove(), u.attr("data-text", u.text()), m.append('<div class="form-error" style="display: none;">' + m.attr("data-error") + "</div>"), m.append('<div class="form-success" style="display: none;">' + m.attr("data-success") + "</div>"), d = m.find(".form-error"), c = m.find(".form-success"), m.addClass("attempted-submit"), i.length && "undefined" != typeof i.attr("srcdoc") && "" !== i.attr("srcdoc"))
                if (console.log("Mail list form signup detected."), "undefined" != typeof p && p !== !1 && d.html(p), o = $(m).find(".signup-email-field").val(), n = $(m).find(".signup-name-field").val(), s = $(m).find("input.signup-first-name-field").length ? $(m).find("input.signup-first-name-field").val() : $(m).find(".signup-name-field").val(), r = $(m).find(".signup-last-name-field").val(), 1 !== e(m)) {
                    a = prepareSignup(i), a.find("#mce-EMAIL, #fieldEmail").val(o), a.find("#mce-LNAME, #fieldLastName").val(r), a.find("#mce-FNAME, #fieldFirstName").val(s), a.find("#mce-NAME, #fieldName").val(n), m.removeClass("attempted-submit"), d.fadeOut(200), u.html(jQuery("<div />").addClass("form-loading")).attr("disabled", "disabled");
                    try {
                        $.ajax({
                            url: a.attr("action"),
                            crossDomain: !0,
                            ...
                            success: function(e) {
                                "success" != e.result && 200 != e.Status ? (d.attr("original-error", d.text()), d.html(e.msg).fadeIn(1e3), c.fadeOut(1e3), u.html(u.attr("data-text")).removeAttr("disabled")) : (u.html(u.attr("data-text")).removeAttr("disabled"), l = m.attr("success-redirect"), "undefined" != typeof l && l !== !1 && "" !== l && (window.location = l), m.find('input[type="text"]').val(""), m.find("textarea").val(""), c.fadeIn(1e3), d.fadeOut(1e3), setTimeout(function() {
                                    c.fadeOut(500)
                                }, 5e3))
                            }
                        })
                    } catch (h) {
                        d.attr("original-error", d.text()), d.html(h.message).fadeIn(1e3), c.fadeOut(1e3), setTimeout(function() {
                            d.fadeOut(500)
            ...
            else console.log("Send email form detected."), "undefined" != typeof p && p !== !1 && d.text(p), f = e(m), 1 === f ? (d.fadeIn(200), setTimeout(function() {
                d.fadeOut(500)
            }, 3e3)) : (m.removeClass("attempted-submit"), d.fadeOut(200), u.html(jQuery("<div />").addClass("form-loading")).attr("disabled", "disabled"), jQuery.ajax({
                type: "POST",
                url: "mail/mail.php",
                data: m.serialize() + "&url=" + window.location.href,
                success: function(e) {
                    u.html(u.attr("data-text")).removeAttr("disabled"), $.isNumeric(e) ? parseInt(e) > 0 && (l = m.attr("success-redirect"), "undefined" != typeof l && l !== !1 && "" !== l && (window.location = l), m.find('input[type="text"]').val(""), m.find("textarea").val(""), m.find(".form-success").fadeIn(1e3), d.fadeOut(1e3), setTimeout(function() {
                        c.fadeOut(500)
                    }, 5e3)) : (d.attr("original-error", d.text()), d.text(e).fadeIn(1e3), c.fadeOut(1e3))
                },
                error: function(e, t, a) {
                    d.attr("original-error", d.text()), d.text(a).fadeIn(1e3), c.fadeOut(1e3), u.html(u.attr("data-text")).removeAttr("disabled")
                }
            }));
            return !1
    ...
    var a = setInterval(function() {
        return $(".tweets-slider").find("li.flex-active-slide").length ? void clearInterval(a) : void($(".tweets-slider").length && $(".tweets-slider").flexslider({
            directionNav: !1,
            controlNav: !1
        }))
    }, 500);
    ...
    "undefined" != typeof google && "undefined" != typeof google.maps && $(".map-canvas[data-maps-api-key]").each(function() {
        var e, t, a, i = this,
            ...
            s = "undefined" != typeof $(this).attr("data-map-zoom") && "" !== $(this).attr("data-map-zoom") ? 1 * $(this).attr("data-map-zoom") : 17,
            r = "undefined" != typeof $(this).attr("data-latlong") ? $(this).attr("data-latlong") : !1,
            l = r ? 1 * r.substr(0, r.indexOf(",")) : !1,
            d = r ? 1 * r.substr(r.indexOf(",") + 1) : !1,
            c = new google.maps.Geocoder,
            m = "undefined" != typeof $(this).attr("data-address") ? $(this).attr("data-address").split(";") : !1,
            u = "We Are Here",
            f = $(document).width() > 766 ? !0 : !1,
            p = {
                draggable: f,
                scrollwheel: !1,
                zoom: s,
        ...
        void 0 != $(this).attr("data-marker-title") && "" != $(this).attr("data-marker-title") && (u = $(this).attr("data-marker-title")), void 0 != m && "" != m[0] ? c.geocode({
            address: m[0].replace("[nomarker]", "")
        }, function(e, t) {
            if (t == google.maps.GeocoderStatus.OK) {
                var o = new google.maps.Map(i, p);
                o.setCenter(e[0].geometry.location), m.forEach(function(e) {
                    var t;
                    if (a = {
                        ...
                        t == google.maps.GeocoderStatus.OK && (n = new google.maps.Marker({
                            map: o,
                            icon: a,
                            title: u,
        ...
        }) : void 0 != l && "" != l && 0 != l && void 0 != d && "" != d && 0 != d && (p.center = {
            lat: l,
            lng: d
        }, e = new google.maps.Map(i, p), t = new google.maps.Marker({
            position: {
                lat: l,
                lng: d
            },
...
var mr_cookies = {
    ...
    setItem: function(e, t, a, i, o, n) {
        ...
        return document.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + s + (o ? "; domain=" + o : "") + (i ? "; path=" + i : "") + (n ? "; secure" : ""), !0
    },
...
$(document).ready(function() {
    ...
    }), $(".dropdown-menu ul").hide(), $("#main-menu .nav-menu li span").on("click", function() {
        $(this).prev("ul").slideToggle(300)
    });
    var e = ["left", "right"];
    $("#main-menu").hasClass("right") ? ($(".nav-btn").attr("data-side", "right"), $(".sidebar-nav").addClass("right")) : ($(".nav-btn").attr("data-side", "left"), $(".sidebar-nav").addClass("left"));
    for (var t = 0; t < e.length; ++t) {
        var a = e[t];
        $(".sidebar-nav." + a).sidebar({
            side: a
        })
    }
    $(".nav-btn[data-action]").click(function() {
        var e = $(this),
            t = e.attr("data-action"),
            a = e.attr("data-side");
        return $(".sidebar-nav." + a).trigger("sidebar:" + t), !1
    }), $(".nav-menu li a").on("click", function() {
        $(".sidebar-nav").trigger("sidebar:close"), $(".dropdown-menu ul").hide(300)
    }), (navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPod/i)) && $("#main-menu .nav-menu").css({
        "margin-bottom": "5px"
    })
}), $(document).ready(function() {
    $(".scroll-button a").click(function() {
        $("html, body").animate({
            scrollTop: $("#masonry").offset().top - 90
        }, 1e3)
    }), $(".navigation-gropt .has-submenu > a").click(function() {
        return $(this).parent("li").hasClass("opent-submenu") ? $(this).parent("li").removeClass("opent-submenu") : $(this).parent("li").addClass("opent-submenu"), !1
    }), $(window).scroll(function(e) {
        var t = $(window).scrollTop();
        t > 100 ? $(".scroll-to-top").addClass("open-show") : $(".scroll-to-top").removeClass("open-show")
    ...
    $(".owl-main-banner").owlCarousel({
        ...
        nav: !0,
        dots: !1,
        navText: ['<i class="fa fa-angle-left" aria-hidden="true" style="color:#003159; font-size:40px;"></i>', '<i class="fa fa-angle-right" aria-hidden="true" style="color:#003159; font-size:40px;"></i>'],
        responsive: {
            0: {
                items: 1
            },
    ...
    }), $(".owl-service-banner").owlCarousel({
        loop: !0,
        autoplay: !0,
        autoplaySpeed: 1e3,
        autoplayTimeout: 3e3,
...
$(document).ready(function() {
    /*$(".opt-menu").click(function() {
	   $(this).next('.menu-con').slideToggle('');
   });*/
    $(".opt-menu").mouseenter(function() {
        if (!$(this).parent('.tagle-menu').hasClass('open') && $('.menu-con').hasClass('fadeInDown')) {
            $(this).parent('.tagle-menu').addClass('open');
        }
    });
    $(".tagle-menu").mouseenter(function() {}).mouseleave(function() {
        if ($('.tagle-menu').hasClass('open') && $('.menu-con').hasClass('fadeInDown')) {
            $('.menu-con').removeClass('fadeInDown').addClass('fadeOutUp');
            setTimeout(function() {
                $('.tagle-menu').removeClass('open');
                $('.menu-con').addClass('fadeInDown').removeClass('fadeOutUp');
            }, 1500);
        }
    });
});
...
$(window).load(function() {
    //alert(333);
    setTimeout(function() {
        if ($('.owl-main-banner').size()) {
            $('.menu-con').height($('.owl-main-banner').height());
        } else {
            $('.menu-con').height($('.owl-service-banner').height());

        }
        if ($('.img-banner-all').size()) {
            $('.menu-con').height($('.img-banner-all').height());
        }
    }, 1500);
});